...
function Login({isMenuOpen,IsSetMenuOpen}) {
  return (
    <>
   ...
   <div class="flex justify-center pt-8 ">
    <form class="bg-gray-900 w-sm rounded-2xl">
        ...
        <div class="flex flex-col gap-8 items-center  p-8">
            ...
            <button class="bg-cyan-500 text-white p-2 h-10 font-sans font-bold rounded-xl w-[90%] hover:scale-105 hover:bg-cyan-400 transition-all duration-300 ease-in-out">Login</button>
            <p class="text-white">Don't have an account? <a class="text-cyan-400">Signup</a></p>
